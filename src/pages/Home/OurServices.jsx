...
const OurServices = () => {
  return (
    <div
     ...
     from-[#FAFAFA] from-0% to-[#FCFCFC] to-100% py-16"
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <p className="my-5 text-secondary leading-[20px]">
              Rooted in passion, we curate unforgettable dining experiences and
              offer exceptional services, blending culinary artistry with warm
              hospitality.
            </p>

            <button className="bg-green border-none text-white rounded-full px-8 py-4">
              Explore
            </button>
          </div>
        </div>
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center ">
                {
                    serviceLists.map((service) => (
                        <div key={service.id} className="shadow-md rounded-sm py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:shadow-xl transition-all duration-200">
